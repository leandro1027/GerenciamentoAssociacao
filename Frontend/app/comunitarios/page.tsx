  ...
  return (
    <main className="bg-gray-50 min-h-screen">
      ...
      <div className="max-w-7xl mx-auto py-6 sm:py-8 md:py-10 px-3 sm:px-4 lg:px-8">
        {/* --- Barra de Filtros --- */}
        <div className="bg-white p-4 sm:p-5 rounded-lg shadow-md mb-6 sm:mb-8 border border-gray-100">
        ...
        <div className="mb-6 sm:mb-8 flex justify-center">
            ...
            >
                ...
                <span className="text-center">Visualizar mapeamento de animais comunitários</span>
            </button>
        </div>
