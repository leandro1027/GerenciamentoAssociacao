...
export default function ProfilePage() {
  ...
  const [pontos, setPontos] = useState(0); // NOVO: Estado para a pontuação
  ...
  useEffect(() => {
    if (user) {
      ...
      setPontos(user.pontos || 0); // NOVO: Puxa os pontos do usuário
          ...
          <div className="flex-1">
            {activeView === 'overview' && (
              <div className="bg-white p-8 rounded-2xl shadow-lg animate-fade-in-up">
                ...
                {/* ATUALIZADO: Grid para 3 colunas em telas grandes */}
