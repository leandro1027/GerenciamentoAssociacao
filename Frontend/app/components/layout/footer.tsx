      ...
      <div className="max-w-7xl mx-auto py-16 px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-8 lg:gap-12">
          ...
          <section aria-labelledby="footer-social" className="lg:col-span-1">
            ...
            {/* Newsletter */}
            <div>
              <p className="text-amber-100 text-sm mb-3">Receba nossas novidades</p>
              <div className="flex space-x-2">
                <input
                  type="email"
                  placeholder="Seu e-mail"
                  className="flex-1 px-3 py-2 bg-amber-800 border border-amber-700 rounded-lg text-sm text-white placeholder-amber-300 focus:outline-none focus:ring-2 focus:ring-amber-400 focus:border-transparent"
                />
                <button className="px-4 py-2 bg-amber-700 hover:bg-amber-600 text-white rounded-lg transition-all duration-300 hover:shadow-lg transform hover:scale-105 text-sm font-medium">
                  Inscrever
                </button>
              </div>
            </div>
        ...
        <div className="mt-12 pt-8 border-t border-amber-800">
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            ...
            <div className="flex space-x-6 text-sm">
              <a href="/privacidade" className="text-amber-200 hover:text-amber-300 transition-colors">
                Política de Privacidade
              </a>
              <a href="/termos" className="text-amber-200 hover:text-amber-300 transition-colors">
                Termos de Uso
              </a>
            </div>
