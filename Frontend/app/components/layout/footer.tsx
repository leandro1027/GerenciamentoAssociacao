        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-8 lg:gap-12">
          ...
          <section aria-labelledby="footer-brand" className="lg:col-span-1">
            ...
            <p className="text-amber-100 leading-relaxed text-sm">
              ...
              em Porto União, Santa Catarina e União da Vitória, Paraná. Juntos construímos um mundo 
          ...
          <section aria-labelledby="footer-contact" className="lg:col-span-1">
            ...
            <div className="space-y-4 text-sm">
              <div className="flex items-start space-x-3">
                ...
                <span className="text-amber-100">Porto União, SC e União da Vitória, PR</span>
              </div>
              <div className="flex items-start space-x-3">
                <svg className="w-5 h-5 text-amber-300 mt-0.5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 4.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                </svg>
                <a href="mailto:ASSOC.FABIANAFORTE@GMAIL.COM" className="text-amber-100 hover:text-amber-300 transition-colors">
                  assoc.fabianaforte@gmail.com
                </a>
              </div>
              <div className="flex items-start space-x-3">
                <svg className="w-5 h-5 text-amber-300 mt-0.5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <a href="tel:+5542991462654" className="text-amber-100 hover:text-amber-300 transition-colors">
                  (42) 99146-2654
                </a>
              </div>
            </div>
